...
export default function NavBar() {
    ...
    const items = [
        ...
        {label: 'Verify Hospitals', icon: <Icon icon="cil:hospital" fontSize="30px"/>},
        {label: 'Organ Requests', icon:<Icon icon="healthicons:kidneys" fontSize="40px" />},
        {label: 'Donation Requests', icon: <Icon icon="iconoir:donate" fontSize="40px" />},
    ...
    function Navigatto(e){
        ...
        if(item==='Verify Hospitals'){
         navigate('/admin/verifyhospitals')
        }
        else if(item==='Home'){
            navigate('/admin');
        }
        else if(item==='Organ Requests'){
            navigate('/admin/organrequest');
        }
        else if(item==='Donation Requests'){
            navigate('/admin/donationrequest');
        }
        else if(item==='Logout'){
